  ...
  return (
    <>
      <div className="page-header">
        <h1>Customers</h1>
        <p>Manage and track your customer base. Click any card to view details.</p>
      </div>
      <div className="stat-grid">
        ...
        <StatCard index={2} label="Total MRR" value={`$${mrr.toLocaleString()}`} icon={<MdAttachMoney size={20} />} color="var(--cyan)" />
