...
const insights = [
  { icon: '📈', color: '#8B5CF6', title: 'Revenue Momentum', body: 'MRR grew 18% month-over-month. Enterprise tier is driving the surge — 3 new Enterprise deals closed this month.', score: 82, label: 'Growth Score' },
  ...
  { icon: '💡', color: '#22D3EE', title: 'Expansion Opportunity', body: 'Sneha Patel and Vikram Joshi are nearing their Pro plan limits. Upgrade conversations could add ₹2K+ MRR.', score: 91, label: 'Opportunity Score' },
